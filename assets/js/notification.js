...
/* harmony export (immutable) */ exports["__importStar"] = __importStar;
/* harmony export (immutable) */ exports["__importDefault"] = __importDefault;
/*! *****************************************************************************
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__firebase_messaging__ = __webpack_require__(164);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_tslib__ = __webpack_require__(139);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__firebase_app__ = __webpack_require__(9);
...
var TokenDetailsModel = /** @class */ (function (_super) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_tslib__["__extends"])(TokenDetailsModel, _super);
            ...
            case 2: {
                ...
                cursorRequest_1.onsuccess = function () {
                    ...
                    if (cursor) {
                        ...
                        var newValue = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_tslib__["__assign"])({}, value);
                        if (!value.createTime) {
...
var VapidDetailsModel = /** @class */ (function (_super) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_tslib__["__extends"])(VapidDetailsModel, _super);
...
var SwController = /** @class */ (function (_super) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_tslib__["__extends"])(SwController, _super);
    ...
    SwController.prototype.getNotificationData_ = function (msgPayload) {
        ...
        var notificationInformation = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_tslib__["__assign"])({}, msgPayload.notification);
        // Put the message payload under FCM_MSG name so we can identify the
        // notification as being an FCM notification vs a notification from
        // somewhere else (i.e. normal web push or developer generated
        // notification).
        notificationInformation.data = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_tslib__["__assign"])({}, msgPayload.notification.data, (_a = {}, _a[FCM_MSG] = msgPayload, _a));
...
var WindowController = /** @class */ (function (_super) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_tslib__["__extends"])(WindowController, _super);
    /**
    ...
    function WindowController(app) {
        ...
        _this.onMessageInternal = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__firebase_util__["createSubscribe"])(function (observer) {
            _this.messageObserver = observer;
        });
        _this.onTokenRefreshInternal = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__firebase_util__["createSubscribe"])(function (observer) {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(setImmediate, global) {Object.defineProperty(exports, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_whatwg_fetch__ = __webpack_require__(185);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(162).setImmediate, __webpack_require__(6)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_firebase_app__ = __webpack_require__(158);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_firebase_app___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_firebase_app__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_firebase_messaging__ = __webpack_require__(159);
...
const config = {
    apiKey: "AIzaSyBTjATUd31XpP1hJzi_KAZ6xhbD5qI1IRU",
    authDomain: "iioffice-app.firebaseapp.com",
    databaseURL: "https://iioffice-app.firebaseio.com",
    projectId: "iioffice-app",
    storageBucket: "iioffice-app.appspot.com",
    messagingSenderId: "789677052146"
};

__WEBPACK_IMPORTED_MODULE_1_firebase_app___default.a.initializeApp(config);

console.log("Laravel");

const messaging = __WEBPACK_IMPORTED_MODULE_1_firebase_app___default.a.messaging();
const channel = new BroadcastChannel('notificationCounter');
...
channel.addEventListener('message', event => {
    updateNotificationCounter(event.data);
});
...
messaging.onTokenRefresh(function () {
    messaging.getToken().then(function (refreshedToken) {
        ...
        subscribeTokenToTopic(accessToken);
    }).catch(function (err) {
...
function subscribeTokenToTopic(token) {
    ...
    const topic = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('body').attr('data-topic');
    fetch('https://iid.googleapis.com/iid/v1/' + token + '/rel/topics/' + topic, {
        method: 'POST',
        headers: new Headers({
            'Authorization': 'key=AAAAt9xrkPI:APA91bGKcapuKoNTaIfQrvPtcLOwLv206Aq3FaFB1D8fdhUSzLN9renpEo851KPKdhSuOVxLKE12lkuXeDXH25bpHyqSCuM1AN7ZeUPL3_u_sVBNR4VZlA__jX8WKW8wLqKmp0hIcIGb',
            'Content-Type': 'application/json'
        })
    }).then(response => {
...
function updateNotificationCounter(payload) {
    let notificationLength = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.notification-counter').length;
    let notificationMessageLength = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.notification-message-counter').length;

    if (notificationLength) {
        let notificationCounter = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.notification-counter');
        let counter = parseInt(notificationCounter.attr('data-notification-counter')) + 1;
        notificationCounter.attr('data-notification-counter', counter);
        notificationCounter.html(counter);
    }

    if (notificationMessageLength) {
        let notificationMessageCounter = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.notification-message-counter');
        let notificationList = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.notification-list');
        let counter = parseInt(notificationMessageCounter.attr('data-notification-message-counter')) + 1;
        notificationMessageCounter.attr('data-notification-message-counter', counter);
        notificationMessageCounter.html(counter);
        let content = payload.notification.body,
            link = payload.notification.click_action;

        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('<li><a href="' + link + '"><i class="fa fa-user text-aqua"></i> ' + content + '</a></li>').prependTo('.notification-list');
    }
}
...
/******/ });
//# sourceMappingURL=maps/notification.map