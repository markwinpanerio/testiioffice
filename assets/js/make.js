...
function dynamicMap() {
  ...
  var japan = document.querySelector('#js-map-iioffice').getAttribute('data-address');
  ...
  function geocodeAddress(geocoder, resultsMap) {
    var setPinButton = document.querySelector('#js-address-map-button');
    var setPinAddress = document.querySelectorAll('.js-address-map');
    // let pinAddress;
    ...
    setPinButton.addEventListener('click', function (e) {
      e.preventDefault();
      var pinAddress = '';
      for (var iPinAddressValue = 0; iPinAddressValue < setPinAddress.length; iPinAddressValue++) {
...
var _dynamicMap = __webpack_require__(330);

var _dynamicMap2 = _interopRequireDefault(_dynamicMap);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _dynamicMap2.default)();
...
var makeBranchService = document.querySelectorAll('.js-make-branch-service');
var makeBranchServiceFirstChild = makeBranchService[0];
var makeBranchServiceParent = document.querySelector('#js-make-branch-parent');
var makeBranchServiceButton = document.querySelector('#js-add-service');
var makeBranchClone = void 0;
...
//end of cloning services//
//end of calendar date picker//


//start of calendar date picker//
// $('#js-start-calendar').daterangepicker();
